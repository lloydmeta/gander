...
class Article {
  ...
  */
   ...
   * This is populated by an implementation of {@link goose.extractors.AdditionalDataExtractor}
   * which is executed before document cleansing within {@link goose.CrawlingActor#crawl}
