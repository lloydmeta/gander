      ...
      if (kid.nodeName() == "p" && replacementText.size > 0) {
        ...
        if (replaceText.trim().length > 1) {
          ...
          while (prevSibNode != null && prevSibNode.nodeName() == "a" && prevSibNode.attr(
            ...
            prevSibNode =
              if (prevSibNode.previousSibling() == null) null else prevSibNode.previousSibling()
          }
          ...
          while (nextSibNode != null && nextSibNode.nodeName() == "a" && nextSibNode.attr(
            ...
            nextSibNode =
              if (nextSibNode.nextSibling() == null) null else nextSibNode.nextSibling()
          }
...
object DocumentCleaner extends Logging {
  ...
  val blockElemementTags =
    TagsEvaluator("a", "blockquote", "dl", "div", "img", "ol", "p", "pre", "table", "ul")
